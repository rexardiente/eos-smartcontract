...
//         mhlgamedata &game_data = modified_mahjonghilo.game_data;
...
//     _mjhilos.modify(user, _self, [&](auto &modified_mjhilo) {
//         mhlgame &game_data = modified_user.game_data;
//         game_data.hi_lo_balance += quantity;
//     });
// }
...
//     auto &mjhilo = _mjhilos.get(id, "Users doesn't exist");
//     // check(idx <= 13, "Index should be below 14.");
//     check(mjhilo.game_data.status == ONGOING, "Game already ended.");
//     check(mjhilo.game_data.hi_lo_result == LOSE, "Game already ended.");
//     _mjhilos.modify(mjhilo, _self, [&](auto &modified_mjhilo) {
//         mhlgamedata &game_data = modified_mjhilo.game_data;
...
//     _mjhilos.modify(mjhilo, _self, [&](auto &modified_mjhilo) {
//         game &game_data = modified_mjhilo.game_data;
//         game_data.hi_lo_balance += game_data.hi_lo_stake;
//         game_data.hi_lo_stake = 0.0000;
//         game_data.hi_lo_bet = 0.0000;
//     });
...
//     _mjhilos.modify(mjhilo, _self, [&](auto &modified_mjhilo) {
//         mhlgamedata &game_data = modified_user.game_data;
//         game_data.hi_lo_balance = DEFAULT;
