...
// int coinicagames::pung_check(tile tile1, tile tile2, tile tile3)
// {
...
// int coinicagames::wind_check(mhlgame gamedata, tile tile1, int check1)
// {
//     if (tile1.value == 10)
//     {
...
// void coinicagames::getscore(mhlgame &gamedata, vector<uint8_t> &hand)
// {
//     vector<tile> tiles = {};
