...
// void coinicagames::gen_stat(ghost &initial_ghost) // function for generating monster/s status
// {
...
// void coinicagames::battle_step(map<int, ghost>::iterator &ghost1, map<int, ghost>::iterator &ghost2) // battle process
// {
...
// void coinicagames::damage_step(map<int, ghost>::iterator &attacker, map<int, ghost>::iterator &defender, int round) // perform damage calculation
// {
...
// void coinicagames::result_step(map<int, ghost>::iterator &loser, map<int, ghost>::iterator &winner) // modify status and other data values for both characters
// {
