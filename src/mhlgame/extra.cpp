...
//             // for (int i = 0; i < 3; i++)
//             // {
//             // gamedata.hand_player.insert(gamedata.hand_player.end(), tiles[0]);
//             // }
//             // for (int i = 0; i < 3; i++)
//             // {
//             //     gamedata.hand_meld.insert(gamedata.hand_meld.end(), tiles[i]);
//             // }
//             handcheck = 1;
//             for (int i = 0; i < 3; i++)
//             {
//                 gamedata.wintiles.insert(gamedata.wintiles.end(), tiles[i]);
//             }
//         }
//         else if (checking == 1)
//         {
